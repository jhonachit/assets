...
const str = {
  ...
  basePath: "/api",
  tags: [{ name: "gen" }, { name: "clients" }, { name: "servers" }],
  paths: {
    "/gen/download/{fileId}": {
      get: {
      ...
      get: {
        ...
        responses: {
          200: {
            ...
            schema: {
              type: "object",
              additionalProperties: { $ref: "#/definitions/CliOption" },
            },
          },
        },
      },
  ...
  definitions: {
    ...
    GeneratorInput: {
      ...
      properties: {
        ...
        securityDefinition: { $ref: "#/definitions/SecuritySchemeDefinition" },
      },
    },
